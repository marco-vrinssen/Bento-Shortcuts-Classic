...
BentoChatColors = {
    ...
    CORAL        = {1.0, 0.898, 0.898},        -- #FFE5E5
    CORAL_LUA    = "|cFFFFE5E5",               -- #FFE5E5
    RED          = {1.0, 0.3, 0.3},            -- #FF4D4D
    RED_LUA      = "|cFFFF4D4D",               -- #FF4D4D
    ORANGE       = {1.0, 0.6, 0.0},            -- #FF9900
    ORANGE_LUA   = "|cFFFF9900",               -- #FF9900
    YELLOW       = {0.99, 0.95, 0.45},         -- #FCF374
    YELLOW_LUA   = "|cFFFCF374",               -- #FCF374
    PINK         = {1.0, 0.5, 1.0},            -- #FF80FF
    PINK_LUA     = "|cFFFF80FF",               -- #FF80FF
    PINK_LIGHT   = {1.0, 0.8, 1.0},            -- #FFCCFF
    PINK_LIGHT_LUA = "|cFFFFCCFF",             -- #FFCCFF
    BLUE         = {0.67, 0.67, 1.0},          -- #AAAAFF
    BLUE_LUA     = "|cFFAAAAFF",               -- #AAAAFF
    GREEN        = {0.25, 1.0, 0.25},          -- #40FF40
    GREEN_LUA    = "|cFF40FF40",               -- #40FF40
}
