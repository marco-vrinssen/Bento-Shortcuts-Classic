...
local function showCommandList()
    ...
    tooltip:AddLine(YELLOW_LIGHT_LUA .. "/scan KEYWORD" .. "|r" .. WHITE_LUA .. " Monitor chat for keyword" .. "|r")
    tooltip:AddLine(YELLOW_LIGHT_LUA .. "/scan stop" .. "|r" .. WHITE_LUA .. " Stop scanning" .. "|r")
    tooltip:AddLine(YELLOW_LIGHT_LUA .. "/w+ MESSAGE" .. "|r" .. WHITE_LUA .. " Whisper all in /who list" .. "|r")
    tooltip:AddLine(YELLOW_LIGHT_LUA .. "/w+ N MESSAGE" .. "|r" .. WHITE_LUA .. " Whisper first N players" .. "|r")
    tooltip:AddLine(YELLOW_LIGHT_LUA .. "/w+ -CLASS MSG" .. "|r" .. WHITE_LUA .. " Exclude class" .. "|r")
    tooltip:AddLine(YELLOW_LIGHT_LUA .. "/w+- MESSAGE" .. "|r" .. WHITE_LUA .. " Whisper with ignore list" .. "|r")
    tooltip:AddLine(YELLOW_LIGHT_LUA .. "/r+ MESSAGE" .. "|r" .. WHITE_LUA .. " Reply to recent whispers" .. "|r")
    tooltip:AddLine(YELLOW_LIGHT_LUA .. "/r+ N MESSAGE" .. "|r" .. WHITE_LUA .. " Reply to last N senders" .. "|r")
